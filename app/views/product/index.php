                ...
                <div class="men">
                    <div class="single_top">
                        <div class="col-md-9 single_right">
                            ...
                            <div class="desc1 span_3_of_2">
                                ...
                                <p class="m_5">৳ <?php echo $data['products'][0]->price?></p>
                                <div class="btn_form">
                    ...
                    <div class="single_span_3">
                        ...
                        <div class="col-sm-3 span_4">
                            <img src="<?php echo URLROOT; ?>/img/product/<?php echo $relatedProducts->product_base_img?>" class="img-responsive" alt="" style="width: 200px !important; height: 300px !important;" />
